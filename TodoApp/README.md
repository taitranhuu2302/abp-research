...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 4629341a-b2de-4d8c-853e-799a8fa5805b
```

> `4629341a-b2de-4d8c-853e-799a8fa5805b` is the password of the certificate, you can change it to any password you want.
