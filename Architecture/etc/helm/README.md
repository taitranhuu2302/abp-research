...
```
127.0.0.1 architecture-local-web
127.0.0.1 architecture-local-webgateway
127.0.0.1 architecture-local-authserver
```
...
Now, you can browse the URL: `https://architecture-local-web`
